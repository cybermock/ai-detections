## Architect Notes
---
### Local LLM Listening Port Detected
...
### Tuning
- Use `hdsi_ai_local_llm_listening_port_detected_filter` macro for exclusions
- Use `hdsi_ai_local_llm_listening_port_detected_customizations` macro for post-processing
